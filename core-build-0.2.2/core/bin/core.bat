...
set DEFAULT_JVM_OPTS="-Dmrn.runtime.dirProvider=xin.env.WindowsUserDirProvider"
...
@rem Execute core
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CORE_OPTS%  -classpath "%CLASSPATH%" xin.Xin %CMD_LINE_ARGS%
